...
public class CircularArrayQueue<E> implements Queue<E> {
    ...
    // Constructor que acepta un tamaño máximo para la cola.
    ...
    // Calcula el siguiente índice en el arreglo de manera circular.
    ...
    public E poll() {
        if (!isEmpty()) {
            ...
            elements[head] = null; // Limpia la referencia 
            head = nextIndex(head); // Actualiza circular'head' al siguiente índice .
